      ...
      <div className="student">
        ...
        <div className="container">
          <div className="content">
            ...
            <Link to="/study/ozone">Ozone</Link> and{" "}
            <Link to="/study/particulate-matter">Particulate Matter</Link> are
            two pollutants that make up most of the air pollution in our
            country.
          </div>
          <div className="content">
            ...
            To reduce exposure to particulate matter when the{" "}
            <Link to="/study/aqi">AQI</Link> is orange or worse, don't play near
            streets with heavy traffic. Heavy traffic areas are highways and
            busy streets where there are a lot of cars, buses, and trucks.
          </div>
        </div>
        <Controls />
      </div>
